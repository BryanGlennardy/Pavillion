        ...
        <div class="scroll-sidebar mt-5 row align-items-start">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('Admin/getAllHotel'); ?>" aria-expanded="false">
                            <i class="fa fa-table" aria-hidden="true"></i>
                                ...
                                <tbody>
                                    <?php foreach ($result as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row['namaHotel']; ?></td>
                                            <td><?= $row['emailUser']; ?></td>
                                            <td><?= $row['namaLengkapTamu']; ?></td>
                                            <td><?= $row['nomorTeleponTamu']; ?></td>
                                            <td><?= $row['emailTamu']; ?></td>
                                            <td><?= $row['jumlahKamar']; ?></td>
                                            <td><?= $row['checkIn']; ?></td>
                                            <td><?= $row['checkOut']; ?></td>
                                            <td><?= $row['harga']; ?></td>
                                            <td><?= $row['jamTanggalBooking']; ?></td>
                                            <td class="text-nowrap">
                                                <form action="<?= base_url('/deletebook/' . $row['idBooking']); ?>" method="POST" class="d-inline">
