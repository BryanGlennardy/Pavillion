...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('assets/images/gk_ada_bg.png'); ?>">
    <!-- Custom CSS -->
...
<body>
    ...
    <script src="<?= base_url('assets/admin/bootstrap/dist/js/bootstrap.bundle.min.js'); ?>"></script>
